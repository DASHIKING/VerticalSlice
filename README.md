...
2. The feature I am building is the handcart and collection point system, which allows the player to drag a cart around the museum, place collected items into it, and submit those items at a collection point to progress toward escaping.
